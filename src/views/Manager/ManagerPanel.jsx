...
export default function ManagerPanel() {
  ...
  return (
    <div className="h-screen overflow-hidden bg-forest-950 flex">
      {/* Sidebar */}
      <aside className="w-52 flex-shrink-0 bg-forest-900 border-r border-white/5 flex flex-col h-full">
        {/* Brand */}
